  ...
  return (
    <>
            ...
            <div className="col-auto">
              ...
              >
                <div
                  className={
                    currentStep === index
                      ? "active size-40 rounded-full flex-center bg-light-2"
                      : "size-40 rounded-full flex-center bg-blue-1-05 text-dark-3 fw-500"
                  }
                >
                  {currentStep === index ? (
                    <>
      ...
      <div className="row x-gap-20 y-gap-20 pt-20">
        <div className="col-auto">
          <button
            className="button h-60 px-24 -light-2 bg-blue-1 text-white"

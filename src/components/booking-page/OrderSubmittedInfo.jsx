          ...
          <div className="border-type-1 rounded-8 px-50 py-35 mt-40">
            <div className="row">
              <div className="col-lg-3 col-md-6">
                ...
                <div className="text-15 lh-12 fw-500 text-dark-3 mt-10">
                  13119
                </div>
              </div>
              {/* End .col */}
            ...
            <div className="row y-gap-10">
              <div className="col-12">
                <div className="d-flex justify-between ">
                  ...
                  <div className="text-15 lh-16 fw-500 text-dark-3">System</div>
                </div>
              </div>
              {/* End .col */}
              <div className="col-12">
                <div className="d-flex justify-between border-top-light pt-10">
                  ...
                  <div className="text-15 lh-16 fw-500 text-dark-3">Admin</div>
                </div>
              </div>
              {/* End .col */}
              <div className="col-12">
                <div className="d-flex justify-between border-top-light pt-10">
                  ...
                  <div className="text-15 lh-16 fw-500 text-dark-3">
